...
section "install"
    ...
    ; File association for .dsproj files
    WriteRegStr HKCR ".dsproj" "" "DecentSamplerProject"
    WriteRegStr HKCR "DecentSamplerProject" "" "DecentSampler Project File"
    WriteRegStr HKCR "DecentSamplerProject\DefaultIcon" "" "$\"$INSTDIR\DecentSamplerLibraryCreator.exe$\",0"
    WriteRegStr HKCR "DecentSamplerProject\shell\open\command" "" "$\"$INSTDIR\DecentSamplerLibraryCreator.exe$\" $\"%1$\""
sectionEnd
...
section "uninstall"
    ...
    ; Remove file association for .dsproj files
    DeleteRegKey HKCR "DecentSamplerProject\shell\open\command"
    DeleteRegKey HKCR "DecentSamplerProject\DefaultIcon"
    DeleteRegKey HKCR "DecentSamplerProject"
    DeleteRegKey HKCR ".dsproj"
sectionEnd